...
public class AdminService {
    ...
    // Create admin
    public AdminResponseDto createAdmin(AdminCreateRequestDto request, Long superAdminAppUserId) {
        ...
        if (adminRepository.existsByAppUser_Id(request.getAppUserId())) {
            throw new DuplicateResourceException("Admin profile already exists");
        }
